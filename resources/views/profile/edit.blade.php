                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="firstname" id="input-name" class="form-control form-control-alternative{{ $errors->has('firstname') ? ' is-invalid' : '' }}" placeholder="{{ __('First Name') }}" value="{{ old('firstname', auth()->user()->firstname) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="lastname" id="input-name" class="form-control form-control-alternative{{ $errors->has('lastname') ? ' is-invalid' : '' }}" placeholder="{{ __('Last Name') }}" value="{{ old('lastname', auth()->user()->lastname) }}" required autofocus>
